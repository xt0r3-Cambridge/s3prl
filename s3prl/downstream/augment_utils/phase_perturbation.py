...
#   Synopsis     [ Phase Perturbation implementation for S3PRL ]
#   Author       [ S3PRL, Kornel Szabo ]
#   Copyright    [ Copyleft(c) ]
"""*********************************************************************************************"""
# Phase Perturbation implementation for SUPERB Author: Kornel Szabo, University of Cambridge
...
class PhasePerturbation(torch.nn.Module):
    def __init__(
        ...
        """
        Creates an object that performs [phase perturbation](https://arxiv.org/pdf/2312.08571.pdf)
        to any input.
        ...
        - pad_mode:
        """
        super(PhasePerturbation, self).__init__()
    ...
    def forward(
        ...
        """
        Computes the phase perturbation of the input audio.
